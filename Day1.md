...
- Dựa vào **các nghiên cứu liên quan** để đề xuất chủ đề
...
2. **Introduction**
3. **Related Work**  
   - Trình bày các nghiên cứu liên quan đến chủ đề  
   - Định vị nghiên cứu của mình trong bối cảnh các công trình trước  
   - Chỉ ra **research gap**  
